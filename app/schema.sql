...
CREATE INDEX idx_encounters_scheme ON encounters (scheme)
CREATE INDEX idx_encounters_outcome ON encounters (outcome)
CREATE INDEX idx_encounters_date_scheme ON encounters (date, scheme)
CREATE INDEX idx_encounters_date_facility ON encounters (date, facility_id)
